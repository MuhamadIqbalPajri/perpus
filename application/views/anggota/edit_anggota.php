          ...
          <form method="post" action="<?= base_url()?>anggota/simpan" class="form-horizontal">
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" nama="id_anggota" value="<?= $data['id_anggota'];?>" class="form-control" readonly>
                </div>
             </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" nama="nama_anggota"  class="form-control" placeholder="Nama Anggota" required>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" nama="no_hp" value="<?= $data['no_hp'];?>" class="form-control" placeholder="No. HP" required>
              </div>
            </div>
          </div>
